...
zokou({
  ...
  caption: `╭━━PRINCE-MD downloader menu━━╮
...
zokou({
  ...
  caption: `╭━━PRINCE-MD download menu━━╮
...
_*Downloading...*_`
      ...
      fileStream.on('finish', () => {
        ...
        zk.sendMessage(origineMessage, { video: { url :"./video.mp4"} , caption: "*PRINCE-MD", gifPlayback: false }, { quoted: ms });
      });
